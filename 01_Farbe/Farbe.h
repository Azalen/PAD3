...
public:
    ...
    static constexpr float DEF_GREY_FAC = 0.7;
    ...
    void eingabe();
    void ausgabe(std::ostream & ostr = std::cout, bool withEnter = true) const;
    ...
    // FRIEND METHODEN
    friend std::ostream & operator<<(std::ostream &, const Farbe &);
...
std::ostream & operator<<(std::ostream &, const Farbe &);
